"""
🎭 OOP POLYMORPHISM - Polymorphism Basics
=========================================
...
print("\n=== POLYMORPHISM WITH PAYMENT PROCESSORS ===")
...
# Test media player polymorphism
print("=== Media Player Polymorphism ===")
players = [
    AudioPlayer(),
    VideoPlayer(),
    StreamingPlayer()
...
media_files = ["song.mp3", "movie.mp4", "live_stream"]

for player, media in zip(players, media_files):
    print(f"{player.__class__.__name__}:")
    print(f"  {player.play(media)}")
    print(f"  {player.pause()}")
    print(f"  {player.stop()}")
    print()
